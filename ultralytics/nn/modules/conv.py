...
class ASFF(nn.Module):
    """Adaptive Spatial Feature Fusion (ASFF) module for three-scale feature aggregation (P3, P4, P5). Correctly
    implements channel alignment for all three inputs before fusion.
    """
